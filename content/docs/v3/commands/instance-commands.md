...
`--requiredVersion`     |  n/a  | Version of Aggregator Runtime required. This is mutually exclusive with `--sourceUrl`. The matching version is retrieved from GitHub and uploaded to the Azure Function App.
